...
<template>
  <nav class="bg-white w-full border-b md:border-0 md:static">
    <div class="items-center px-4 max-w-screen-xl mx-auto md:flex md:px-8">
      <div
        class="flex flex-row items-center justify-between py-3 md:py-5 md:block"
      >
        <AppLogo />
        <div class="md:hidden">
          <button
      ...
      <div class="flex flex-row gap-2">
        <div class="hidden md:inline-block">
          <a
            class="py-3 px-4 text-white bg-gray-700 hover:bg-gray-800 rounded-md shadow"
          >
            Login
          </a>
        </div>
        <div class="hidden md:inline-block">
          <a
            class="py-3 px-4 text-white bg-teal-700 hover:bg-teal-800 rounded-md shadow"
          >
            Register
          </a>
        </div>
